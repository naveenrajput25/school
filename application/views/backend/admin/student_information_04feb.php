                                            ...
                                            <td>
                                              <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                                  ...
                                                  <a class="dropdown-item" href="<?php echo base_url(); ?><?php echo $account_type; ?>/student_edit/<?php echo $row['student_id'];?>" ><i class="bx bxs-pencil mr-2"></i><?php echo get_phrase('edit');?></a>

                                                  <a class="dropdown-item text-danger" href="JavaScript:Void(0);" onclick="confirm_modal('<?php echo base_url();?>admin/student/<?php echo $row['class_id'];?>/delete/<?php echo $row['student_id'];?>');"><i class="bx bxs-trash mr-2"></i> <?php echo get_phrase('delete');?></a>
                                                </div>
                                              </div>
                                            </td>
